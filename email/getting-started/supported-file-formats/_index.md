...
description: "Aspose.Email Cloud API supports MSG, EML, HTML, MHTML, VCF, ICS, TNEF, EMLX, PNG, JPG, TIFF, BMP, GIF file formats."
weight: 20
---
...
- [MHTML](https://wiki.fileformat.com/web/mhtml/)
## **Contact**
- [VCF](https://wiki.fileformat.com/email/vcf/)
- [MSG](https://wiki.fileformat.com/email/msg/)
## **iCalendar**
...
- [JPG or JPEG](https://wiki.fileformat.com/image/jpeg/)
