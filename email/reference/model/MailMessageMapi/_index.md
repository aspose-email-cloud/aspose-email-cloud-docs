---
title: "MailMessageMapi"
type: docs
url: /reference-model-mail-message-mapi/
weight: 1
---
...
---- | ---- | ----------- | -----
**Value** | [**MapiMessageDto**](/email/reference-model-mapi-message-dto/) | Email message object.              | 
...
```java
MailMessageMapi mailMessageMapi = Models.mailMessageMapi()
