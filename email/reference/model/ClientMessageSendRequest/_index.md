---
title: "ClientMessageSendRequest"
type: docs
url: /reference-model-client-message-send-request/
weight: 1
---
...
---- | ---- | ----------- | -----
**Message** | [**MailMessageBase**](/email/reference-model-mail-message-base/) | Message to send              | 
